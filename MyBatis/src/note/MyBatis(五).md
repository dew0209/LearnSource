...
**代码生成器**：包含了数据库表对应的实体类，Mapper接口类，Mapper XML文件和Example对象等。
...
[示例](../main/resources/mbg/generatorConfig.xml) 
...
[测试](../test/java/mbg/MbgTest.java) 

## 执行方式三:

[示例](../main/resources/mbg/generatorConfig-cmd.xml) 

和

[cmd](../main/resources/mbg/cmd.txt)